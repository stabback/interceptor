...
import validateResponse from './response.middleware';
...
describe('validate response middleware', () => {
    ...
    it('returns an error if the intercept does not have this response', () => {
    ...
    it('calls the next function if there is an intercept with this response', () => {
        req.params.intercept = 'foo';
        req.url = 'foo';
